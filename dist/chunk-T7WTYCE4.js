...
import { applyDecorators as applyDecorators5, HttpStatus } from "@nestjs/common";
...
function getMessageFromStatusCode(statusCode) {
  switch (statusCode) {
    case HttpStatus2.BAD_REQUEST:
      return "Bad Request";
    case HttpStatus2.UNAUTHORIZED:
      return "Unauthorized";
    case HttpStatus2.FORBIDDEN:
      return "Forbidden";
    case HttpStatus2.NOT_FOUND:
      return "Not Found";
    case HttpStatus2.CONFLICT:
      return "Conflict";
    case HttpStatus2.TOO_MANY_REQUESTS:
      return "Too Many Requests";
    case HttpStatus2.INTERNAL_SERVER_ERROR:
...
function getStatusConfigs(options) {
  return [
    {
      status: HttpStatus3.BAD_REQUEST,
...
//# sourceMappingURL=chunk-T7WTYCE4.js.map